    ...
    <details class="job-card glass-card reveal">
      <summary class="job-summary">
        <div class="job-summary-info">
          ...
          <h3>${e.title}</h3>
          <div class="job-meta">
            <span class="job-meta-item"><i data-lucide="calendar"></i>${e.startDate}</span>
